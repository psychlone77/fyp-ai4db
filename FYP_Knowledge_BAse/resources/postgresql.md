...
Supported Versions: [Current](https://www.postgresql.org/docs/current/runtime-config-resource.html "PostgreSQL 18 - 19.4. Resource Consumption") ([18](https://www.postgresql.org/docs/18/runtime-config-resource.html "PostgreSQL 18 - 19.4. Resource Consumption")) / [17](https://www.postgresql.org/docs/17/runtime-config-resource.html "PostgreSQL 17 - 19.4. Resource Consumption") / [16](https://www.postgresql.org/docs/16/runtime-config-resource.html "PostgreSQL 16 - 19.4. Resource Consumption") / [15](https://www.postgresql.org/docs/15/runtime-config-resource.html "PostgreSQL 15 - 19.4. Resource Consumption") / [14](https://www.postgresql.org/docs/14/runtime-config-resource.html "PostgreSQL 14 - 19.4. Resource Consumption")
Development Versions: [devel](https://www.postgresql.org/docs/devel/runtime-config-resource.html "PostgreSQL devel - 19.4. Resource Consumption")
Unsupported versions: [13](https://www.postgresql.org/docs/13/runtime-config-resource.html "PostgreSQL 13 - 19.4. Resource Consumption") / [12](https://www.postgresql.org/docs/12/runtime-config-resource.html "PostgreSQL 12 - 19.4. Resource Consumption") / [11](https://www.postgresql.org/docs/11/runtime-config-resource.html "PostgreSQL 11 - 19.4. Resource Consumption") / [10](https://www.postgresql.org/docs/10/runtime-config-resource.html "PostgreSQL 10 - 19.4. Resource Consumption") / [9.6](https://www.postgresql.org/docs/9.6/runtime-config-resource.html "PostgreSQL 9.6 - 19.4. Resource Consumption") / [9.5](https://www.postgresql.org/docs/9.5/runtime-config-resource.html "PostgreSQL 9.5 - 19.4. Resource Consumption") / [9.4](https://www.postgresql.org/docs/9.4/runtime-config-resource.html "PostgreSQL 9.4 - 19.4. Resource Consumption") / [9.3](https://www.postgresql.org/docs/9.3/runtime-config-resource.html "PostgreSQL 9.3 - 19.4. Resource Consumption") / [9.2](https://www.postgresql.org/docs/9.2/runtime-config-resource.html "PostgreSQL 9.2 - 19.4. Resource Consumption") / [9.1](https://www.postgresql.org/docs/9.1/runtime-config-resource.html "PostgreSQL 9.1 - 19.4. Resource Consumption") / [9.0](https://www.postgresql.org/docs/9.0/runtime-config-resource.html "PostgreSQL 9.0 - 19.4. Resource Consumption") / [8.4](https://www.postgresql.org/docs/8.4/runtime-config-resource.html "PostgreSQL 8.4 - 19.4. Resource Consumption") / [8.3](https://www.postgresql.org/docs/8.3/runtime-config-resource.html "PostgreSQL 8.3 - 19.4. Resource Consumption") / [8.2](https://www.postgresql.org/docs/8.2/runtime-config-resource.html "PostgreSQL 8.2 - 19.4. Resource Consumption") / [8.1](https://www.postgresql.org/docs/8.1/runtime-config-resource.html "PostgreSQL 8.1 - 19.4. Resource Consumption")
19.4. Resource Consumption  
---  
[Prev](https://www.postgresql.org/docs/current/runtime-config-connection.html "19.3. Connections and Authentication") | [Up](https://www.postgresql.org/docs/current/runtime-config.html "Chapter 19. Server Configuration") | Chapter 19. Server Configuration | [Home](https://www.postgresql.org/docs/current/index.html "PostgreSQL 18.1 Documentation") |  [Next](https://www.postgresql.org/docs/current/runtime-config-wal.html "19.5. Write Ahead Log")  
* * *
## 19.4. Resource Consumption [#](https://www.postgresql.org/docs/current/runtime-config-resource.html#RUNTIME-CONFIG-RESOURCE) 

[19.4.1. Memory](https://www.postgresql.org/docs/current/runtime-config-resource.html#RUNTIME-CONFIG-RESOURCE-MEMORY)


[19.4.2. Disk](https://www.postgresql.org/docs/current/runtime-config-resource.html#RUNTIME-CONFIG-RESOURCE-DISK)
...
[19.4.4. Background Writer](https://www.postgresql.org/docs/current/runtime-config-resource.html#RUNTIME-CONFIG-RESOURCE-BACKGROUND-WRITER)


[19.4.5. I/O](https://www.postgresql.org/docs/current/runtime-config-resource.html#RUNTIME-CONFIG-RESOURCE-IO)
...
`shared_buffers` (`integer`)  [#](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-SHARED-BUFFERS) 
...
`huge_page_size` (`integer`)  [#](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-HUGE-PAGE-SIZE) 
    
Controls the size of huge pages, when they are enabled with [huge_pages](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-HUGE-PAGES). The default is zero (`0`). When set to `0`, the default huge page size on the system will be used. This parameter can only be set at server start.
...
`temp_buffers` (`integer`)  [#](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-TEMP-BUFFERS) 
...
`max_prepared_transactions` (`integer`)  [#](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-MAX-PREPARED-TRANSACTIONS) 
...
If you are not planning to use prepared transactions, this parameter should be set to zero to prevent accidental creation of prepared transactions. If you are using prepared transactions, you will probably want `max_prepared_transactions` to be at least as large as [max_connections](https://www.postgresql.org/docs/current/runtime-config-connection.html#GUC-MAX-CONNECTIONS), so that every session can have a prepared transaction pending.
When running a standby server, you must set this parameter to the same or higher value than on the primary server. Otherwise, queries will not be allowed in the standby server. 

`work_mem` (`integer`)  [#](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-WORK-MEM) 
...
`hash_mem_multiplier` (`floating point`)  [#](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-HASH-MEM-MULTIPLIER) 
...
`maintenance_work_mem` (`integer`)  [#](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-MAINTENANCE-WORK-MEM) 
...
Note that when autovacuum runs, up to [autovacuum_max_workers](https://www.postgresql.org/docs/current/runtime-config-vacuum.html#GUC-AUTOVACUUM-MAX-WORKERS) times this memory may be allocated, so be careful not to set the default value too high. It may be useful to control for this by separately setting [autovacuum_work_mem](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-AUTOVACUUM-WORK-MEM). 

`autovacuum_work_mem` (`integer`)  [#](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-AUTOVACUUM-WORK-MEM) 
    
Specifies the maximum amount of memory to be used by each autovacuum worker process. If this value is specified without units, it is taken as kilobytes. It defaults to -1, indicating that the value of [maintenance_work_mem](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-MAINTENANCE-WORK-MEM) should be used instead. The setting has no effect on the behavior of `VACUUM` when run in other contexts. This parameter can only be set in the `postgresql.conf` file or on the server command line. 

`vacuum_buffer_usage_limit` (`integer`)  [#](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-VACUUM-BUFFER-USAGE-LIMIT) 
...
`logical_decoding_work_mem` (`integer`)  [#](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-LOGICAL-DECODING-WORK-MEM) 
...
`commit_timestamp_buffers` (`integer`)  [#](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-COMMIT-TIMESTAMP-BUFFERS) 
...
`multixact_member_buffers` (`integer`)  [#](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-MULTIXACT-MEMBER-BUFFERS) 
...
`multixact_offset_buffers` (`integer`)  [#](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-MULTIXACT-OFFSET-BUFFERS) 
...
`notify_buffers` (`integer`)  [#](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-NOTIFY-BUFFERS) 
...
`serializable_buffers` (`integer`)  [#](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-SERIALIZABLE-BUFFERS) 
...
`subtransaction_buffers` (`integer`)  [#](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-SUBTRANSACTION-BUFFERS) 
...
`transaction_buffers` (`integer`)  [#](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-TRANSACTION-BUFFERS) 
...
`max_stack_depth` (`integer`)  [#](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-MAX-STACK-DEPTH) 
...
`shared_memory_type` (`enum`)  [#](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-SHARED-MEMORY-TYPE) 
...
`dynamic_shared_memory_type` (`enum`)  [#](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-DYNAMIC-SHARED-MEMORY-TYPE) 
...
`min_dynamic_shared_memory` (`integer`)  [#](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-MIN-DYNAMIC-SHARED-MEMORY) 
...
`temp_file_limit` (`integer`)  [#](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-TEMP-FILE-LIMIT) 
...
`file_copy_method` (`enum`)  [#](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-FILE-COPY-METHOD) 
...
`max_notify_queue_pages` (`integer`)  [#](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-MAX-NOTIFY-QUEUE-PAGES) 
    
Specifies the maximum amount of allocated pages for [NOTIFY](https://www.postgresql.org/docs/current/sql-notify.html "NOTIFY") / [LISTEN](https://www.postgresql.org/docs/current/sql-listen.html "LISTEN") queue. The default value is 1048576. For 8 KB pages it allows to consume up to 8 GB of disk space. This parameter can only be set at server start.
### 19.4.3. Kernel Resource Usage [#](https://www.postgresql.org/docs/current/runtime-config-resource.html#RUNTIME-CONFIG-RESOURCE-KERNEL) 

`max_files_per_process` (`integer`)  [#](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-MAX-FILES-PER-PROCESS) 
...
`bgwriter_delay` (`integer`)  [#](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-BGWRITER-DELAY) 
...
`bgwriter_lru_maxpages` (`integer`)  [#](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-BGWRITER-LRU-MAXPAGES) 
...
`bgwriter_lru_multiplier` (`floating point`)  [#](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-BGWRITER-LRU-MULTIPLIER) 
...
`backend_flush_after` (`integer`)  [#](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-BACKEND-FLUSH-AFTER) 
...
This value can be overridden for tables in a particular tablespace by setting the tablespace parameter of the same name (see [ALTER TABLESPACE](https://www.postgresql.org/docs/current/sql-altertablespace.html "ALTER TABLESPACE")). 
...
The default is `16`. This value can be overridden for tables in a particular tablespace by setting the tablespace parameter of the same name (see [ALTER TABLESPACE](https://www.postgresql.org/docs/current/sql-altertablespace.html "ALTER TABLESPACE")). 

`io_max_combine_limit` (`integer`)  [#](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-IO-MAX-COMBINE-LIMIT) 
...
`io_combine_limit` (`integer`)  [#](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-IO-COMBINE-LIMIT) 
...
`io_max_concurrency` (`integer`)  [#](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-IO-MAX-CONCURRENCY) 
    
Controls the maximum number of I/O operations that one process can execute simultaneously.
The default setting of `-1` selects a number based on [shared_buffers](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-SHARED-BUFFERS) and the maximum number of processes ([max_connections](https://www.postgresql.org/docs/current/runtime-config-connection.html#GUC-MAX-CONNECTIONS), [autovacuum_worker_slots](https://www.postgresql.org/docs/current/runtime-config-vacuum.html#GUC-AUTOVACUUM-WORKER-SLOTS), [max_worker_processes](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-MAX-WORKER-PROCESSES) and [max_wal_senders](https://www.postgresql.org/docs/current/runtime-config-replication.html#GUC-MAX-WAL-SENDERS)), but not more than `64`.
This parameter can only be set at server start. 

`io_method` (`enum`)  [#](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-IO-METHOD) 
...
Selects the method for executing asynchronous I/O. Possible values are:
  ...
  * `io_uring` (execute asynchronous I/O using io_uring, requires a build with [`--with-liburing`](https://www.postgresql.org/docs/current/install-make.html#CONFIGURE-OPTION-WITH-LIBURING) / [`-Dliburing`](https://www.postgresql.org/docs/current/install-meson.html#CONFIGURE-WITH-LIBURING-MESON))
...
`io_workers` (`integer`)  [#](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-IO-WORKERS) 
...
Only has an effect if [io_method](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-IO-METHOD) is set to `worker`.
### 19.4.6. Worker Processes [#](https://www.postgresql.org/docs/current/runtime-config-resource.html#RUNTIME-CONFIG-RESOURCE-WORKER-PROCESSES) 

`max_worker_processes` (`integer`)  [#](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-MAX-WORKER-PROCESSES) 
...
When running a standby server, you must set this parameter to the same or higher value than on the primary server. Otherwise, queries will not be allowed in the standby server.
When changing this value, consider also adjusting [max_parallel_workers](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-MAX-PARALLEL-WORKERS), [max_parallel_maintenance_workers](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-MAX-PARALLEL-MAINTENANCE-WORKERS), and [max_parallel_workers_per_gather](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-MAX-PARALLEL-WORKERS-PER-GATHER). 

`max_parallel_workers_per_gather` (`integer`)  [#](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-MAX-PARALLEL-WORKERS-PER-GATHER) 
    
Sets the maximum number of workers that can be started by a single `Gather` or `Gather Merge` node. Parallel workers are taken from the pool of processes established by [max_worker_processes](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-MAX-WORKER-PROCESSES), limited by [max_parallel_workers](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-MAX-PARALLEL-WORKERS). Note that the requested number of workers may not actually be available at run time. If this occurs, the plan will run with fewer workers than expected, which may be inefficient. The default value is 2. Setting this value to 0 disables parallel query execution.
Note that parallel queries may consume very substantially more resources than non-parallel queries, because each worker process is a completely separate process which has roughly the same impact on the system as an additional user session. This should be taken into account when choosing a value for this setting, as well as when configuring other settings that control resource utilization, such as [work_mem](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-WORK-MEM). Resource limits such as `work_mem` are applied individually to each worker, which means the total utilization may be much higher across all processes than it would normally be for any single process. For example, a parallel query using 4 workers may use up to 5 times as much CPU time, memory, I/O bandwidth, and so forth as a query which uses no workers at all.
For more information on parallel query, see [Chapter 15](https://www.postgresql.org/docs/current/parallel-query.html "Chapter 15. Parallel Query"). 

`max_parallel_maintenance_workers` (`integer`)  [#](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-MAX-PARALLEL-MAINTENANCE-WORKERS) 
...
`max_parallel_workers` (`integer`)  [#](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-MAX-PARALLEL-WORKERS) 
    
Sets the maximum number of workers that the cluster can support for parallel operations. The default value is 8. When increasing or decreasing this value, consider also adjusting [max_parallel_maintenance_workers](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-MAX-PARALLEL-MAINTENANCE-WORKERS) and [max_parallel_workers_per_gather](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-MAX-PARALLEL-WORKERS-PER-GATHER). Also, note that a setting for this value which is higher than [max_worker_processes](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-MAX-WORKER-PROCESSES) will have no effect, since parallel workers are taken from the pool of worker processes established by that setting. 

`parallel_leader_participation` (`boolean`)  [#](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-PARALLEL-LEADER-PARTICIPATION) 
...
* * *
[Prev](https://www.postgresql.org/docs/current/runtime-config-connection.html "19.3. Connections and Authentication") | [Up](https://www.postgresql.org/docs/current/runtime-config.html "Chapter 19. Server Configuration") |  [Next](https://www.postgresql.org/docs/current/runtime-config-wal.html "19.5. Write Ahead Log")  
---|---|---  
19.3. Connections and Authentication  | [Home](https://www.postgresql.org/docs/current/index.html "PostgreSQL 18.1 Documentation") |  19.5. Write Ahead Log  
## Submit correction
If you see anything in the documentation that is not correct, does not match your experience with the particular feature or requires further clarification, please use [this form](https://www.postgresql.org/account/comments/new/18/runtime-config-resource.html/) to report a documentation issue. 
