...
Supported Versions: [Current](https://www.postgresql.org/docs/current/transaction-iso.html "PostgreSQL 18 - 13.2. Transaction Isolation") ([18](https://www.postgresql.org/docs/18/transaction-iso.html "PostgreSQL 18 - 13.2. Transaction Isolation")) / [17](https://www.postgresql.org/docs/17/transaction-iso.html "PostgreSQL 17 - 13.2. Transaction Isolation") / [16](https://www.postgresql.org/docs/16/transaction-iso.html "PostgreSQL 16 - 13.2. Transaction Isolation") / [15](https://www.postgresql.org/docs/15/transaction-iso.html "PostgreSQL 15 - 13.2. Transaction Isolation") / [14](https://www.postgresql.org/docs/14/transaction-iso.html "PostgreSQL 14 - 13.2. Transaction Isolation")
Development Versions: [devel](https://www.postgresql.org/docs/devel/transaction-iso.html "PostgreSQL devel - 13.2. Transaction Isolation")
Unsupported versions: [13](https://www.postgresql.org/docs/13/transaction-iso.html "PostgreSQL 13 - 13.2. Transaction Isolation") / [12](https://www.postgresql.org/docs/12/transaction-iso.html "PostgreSQL 12 - 13.2. Transaction Isolation") / [11](https://www.postgresql.org/docs/11/transaction-iso.html "PostgreSQL 11 - 13.2. Transaction Isolation") / [10](https://www.postgresql.org/docs/10/transaction-iso.html "PostgreSQL 10 - 13.2. Transaction Isolation") / [9.6](https://www.postgresql.org/docs/9.6/transaction-iso.html "PostgreSQL 9.6 - 13.2. Transaction Isolation") / [9.5](https://www.postgresql.org/docs/9.5/transaction-iso.html "PostgreSQL 9.5 - 13.2. Transaction Isolation") / [9.4](https://www.postgresql.org/docs/9.4/transaction-iso.html "PostgreSQL 9.4 - 13.2. Transaction Isolation") / [9.3](https://www.postgresql.org/docs/9.3/transaction-iso.html "PostgreSQL 9.3 - 13.2. Transaction Isolation") / [9.2](https://www.postgresql.org/docs/9.2/transaction-iso.html "PostgreSQL 9.2 - 13.2. Transaction Isolation") / [9.1](https://www.postgresql.org/docs/9.1/transaction-iso.html "PostgreSQL 9.1 - 13.2. Transaction Isolation") / [9.0](https://www.postgresql.org/docs/9.0/transaction-iso.html "PostgreSQL 9.0 - 13.2. Transaction Isolation") / [8.4](https://www.postgresql.org/docs/8.4/transaction-iso.html "PostgreSQL 8.4 - 13.2. Transaction Isolation") / [8.3](https://www.postgresql.org/docs/8.3/transaction-iso.html "PostgreSQL 8.3 - 13.2. Transaction Isolation") / [8.2](https://www.postgresql.org/docs/8.2/transaction-iso.html "PostgreSQL 8.2 - 13.2. Transaction Isolation") / [8.1](https://www.postgresql.org/docs/8.1/transaction-iso.html "PostgreSQL 8.1 - 13.2. Transaction Isolation") / [8.0](https://www.postgresql.org/docs/8.0/transaction-iso.html "PostgreSQL 8.0 - 13.2. Transaction Isolation") / [7.4](https://www.postgresql.org/docs/7.4/transaction-iso.html "PostgreSQL 7.4 - 13.2. Transaction Isolation") / [7.3](https://www.postgresql.org/docs/7.3/transaction-iso.html "PostgreSQL 7.3 - 13.2. Transaction Isolation") / [7.2](https://www.postgresql.org/docs/7.2/transaction-iso.html "PostgreSQL 7.2 - 13.2. Transaction Isolation") / [7.1](https://www.postgresql.org/docs/7.1/transaction-iso.html "PostgreSQL 7.1 - 13.2. Transaction Isolation")
13.2. Transaction Isolation  
---  
[Prev](https://www.postgresql.org/docs/current/mvcc-intro.html "13.1. Introduction") | [Up](https://www.postgresql.org/docs/current/mvcc.html "Chapter 13. Concurrency Control") | Chapter 13. Concurrency Control | [Home](https://www.postgresql.org/docs/current/index.html "PostgreSQL 18.1 Documentation") |  [Next](https://www.postgresql.org/docs/current/explicit-locking.html "13.3. Explicit Locking")  
* * *
## 13.2. Transaction Isolation [#](https://www.postgresql.org/docs/current/transaction-iso.html#TRANSACTION-ISO) 
...
The SQL standard and PostgreSQL-implemented transaction isolation levels are described in [Table 13.1](https://www.postgresql.org/docs/current/transaction-iso.html#MVCC-ISOLEVEL-TABLE "Table 13.1. Transaction Isolation Levels").
...
To set the transaction isolation level of a transaction, use the command [SET TRANSACTION](https://www.postgresql.org/docs/current/sql-set-transaction.html "SET TRANSACTION").
### Important
Some PostgreSQL data types and functions have special rules regarding transactional behavior. In particular, changes made to a sequence (and therefore the counter of a column declared using `serial`) are immediately visible to all other transactions and are not rolled back if the transaction that made the changes aborts. See [Section 9.17](https://www.postgresql.org/docs/current/functions-sequence.html "9.17. Sequence Manipulation Functions") and [Section 8.1.4](https://www.postgresql.org/docs/current/datatype-numeric.html#DATATYPE-SERIAL "8.1.4. Serial Types").
### 13.2.1. Read Committed Isolation Level [#](https://www.postgresql.org/docs/current/transaction-iso.html#XACT-READ-COMMITTED)
...
For optimal performance when relying on Serializable transactions for concurrency control, these issues should be considered:
  ...
  * Don't leave connections dangling “idle in transaction” longer than necessary. The configuration parameter [idle_in_transaction_session_timeout](https://www.postgresql.org/docs/current/runtime-config-client.html#GUC-IDLE-IN-TRANSACTION-SESSION-TIMEOUT) may be used to automatically disconnect lingering sessions.
  ...
  * When the system is forced to combine multiple page-level predicate locks into a single relation-level predicate lock because the predicate lock table is short of memory, an increase in the rate of serialization failures may occur. You can avoid this by increasing [max_pred_locks_per_transaction](https://www.postgresql.org/docs/current/runtime-config-locks.html#GUC-MAX-PRED-LOCKS-PER-TRANSACTION), [max_pred_locks_per_relation](https://www.postgresql.org/docs/current/runtime-config-locks.html#GUC-MAX-PRED-LOCKS-PER-RELATION), and/or [max_pred_locks_per_page](https://www.postgresql.org/docs/current/runtime-config-locks.html#GUC-MAX-PRED-LOCKS-PER-PAGE).
  * A sequential scan will always necessitate a relation-level predicate lock. This can result in an increased rate of serialization failures. It may be helpful to encourage the use of index scans by reducing [random_page_cost](https://www.postgresql.org/docs/current/runtime-config-query.html#GUC-RANDOM-PAGE-COST) and/or increasing [cpu_tuple_cost](https://www.postgresql.org/docs/current/runtime-config-query.html#GUC-CPU-TUPLE-COST). Be sure to weigh any decrease in transaction rollbacks and restarts against any overall change in query execution time.
...
* * *
[Prev](https://www.postgresql.org/docs/current/mvcc-intro.html "13.1. Introduction") | [Up](https://www.postgresql.org/docs/current/mvcc.html "Chapter 13. Concurrency Control") |  [Next](https://www.postgresql.org/docs/current/explicit-locking.html "13.3. Explicit Locking")  
---|---|---  
13.1. Introduction  | [Home](https://www.postgresql.org/docs/current/index.html "PostgreSQL 18.1 Documentation") |  13.3. Explicit Locking  
## Submit correction
If you see anything in the documentation that is not correct, does not match your experience with the particular feature or requires further clarification, please use [this form](https://www.postgresql.org/account/comments/new/18/transaction-iso.html/) to report a documentation issue. 
